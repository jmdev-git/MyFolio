...
export const CARD_DATA = [
  // ── LEFT COLUMN ──────────────────────────────────────────────
  {
    ...
    style: { top: '5%', left: '2%', width: 190, height: 230 },
    rotate: -4,
    exitX: -160,
    exitY: -100,
  },
  {
    ...
    style: { top: '32%', left: '1%', width: 165, height: 190 },
    rotate: 3,
    exitX: -150,
    exitY: 50,
  },
  {
    ...
    alt: 'Design mockup',
    style: { top: '60%', left: '3%', width: 195, height: 145 },
    rotate: -2,
    exitX: -130,
    exitY: 130,
  },
  {
    ...
    style: { top: '80%', left: '18%', width: 175, height: 130 },
    rotate: 5,
    exitX: -80,
    exitY: 170,
  },
  {
    ...
    alt: 'Architecture',
    style: { top: '18%', left: '16%', width: 140, height: 160 },
    rotate: -6,
    exitX: -100,
    exitY: -60,
  },
  // ── RIGHT COLUMN ─────────────────────────────────────────────
  {
    ...
    alt: 'Product render',
    style: { top: '4%', right: '2%', width: 205, height: 140 },
    rotate: 3,
    exitX: 160,
    exitY: -100,
  },
  {
    ...
    alt: 'Creative poster',
    style: { top: '22%', right: '1%', width: 185, height: 170 },
    rotate: -5,
    exitX: 155,
    exitY: 30,
  },
  {
    ...
    alt: 'Branding design',
    style: { top: '48%', right: '3%', width: 165, height: 140 },
    rotate: 4,
    exitX: 140,
    exitY: 100,
  },
  {
    ...
    style: { top: '68%', right: '2%', width: 200, height: 155 },
    rotate: -3,
    exitX: 130,
    exitY: 150,
  },
  {
    ...
    alt: 'Tech workspace',
    style: { top: '34%', right: '18%', width: 150, height: 130 },
    rotate: 6,
    exitX: 90,
    exitY: 60,
  },
